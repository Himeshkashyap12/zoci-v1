        ...
        <div className="sm:px-20 px-5 flex flex-col gap-5  py-20">
          <div className="flex flex-col gap-2">
            ...
            <Typography.Text className="text-[16px]">
              ...
              our site anonymously. Google, as a third party vendor, uses
              cookies to serve ads on our site. Google’s use of the DART cookie
              enables it to serve ads to our users based on their visit to our
              sites and other sites on the Internet. Users may opt out of the
              network privacy policy. What do we use your information for?
            </Typography.Text>
          </div>
          <div className="flex flex-col gap-2">
            <Typography.Text className="text-[30px] fonst-semibold">
            ...
            <Typography.Text className="text-[16px]">
              ...
              from you) • To improve customer service (your information helps us
          ...
          <div className="flex flex-col gap-2">
            <Typography.Text className="text-[20px] fonst-bol">
              • To administer a contest, promotion, survey or other site feature
            </Typography.Text>
            <Typography.Text className="text-[20px] fonst-semibold">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Typography.Text className="text-[16px]">
              ...
              of your personal information when you place an order or access
          ...
          <div className="flex flex-col gap-2">
            ...
            <Typography.Text className="text-[16px]">
              ...
              information We use cookies to help us remember and process the
              items in your shopping cart, understand and save your preferences
              ...
              business. If you prefer, you can choose to have your computer warn
              ...
              properly. However, you can still place orders over the telephone.
            </Typography.Text>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Typography.Text className="text-[16px]">
              ...
              for marketing, advertising, or other uses. Third party links
            </Typography.Text>
            <Typography.Text className="text-[16px]">
            ...
            <Typography.Text className="text-[16px]">
              ...
              information to outside parties without your consent. Childrens
